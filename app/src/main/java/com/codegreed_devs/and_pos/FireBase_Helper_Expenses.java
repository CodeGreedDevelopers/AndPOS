...
/**
 * Created by FakeJoker on 26/02/2018.
 */

public class FireBase_Helper_Expenses {
     ...
     */
    public FireBase_Helper_Expenses(DatabaseReference db){
        this.db=db;
    }
    ...
    public void fetchData(DataSnapshot dataSnapshot)
    {
        ...
        Expenses.expenses_list.invalidateViews();
